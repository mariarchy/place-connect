      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        {isFileUpload ? (
          ...
          <input
            ...
            className="w-full border border-gray-700 bg-transparent px-6 py-4 text-lg font-light text-white placeholder-gray-600 transition-all duration-300 focus:border-white focus:outline-none"
          />
        ) : (
          <textarea
            name={fieldName}
