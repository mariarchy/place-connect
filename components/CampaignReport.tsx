...
export function CampaignReport({
  ...
  const handleSaveAsPDF = () => {
    // Stub for now - could implement html2canvas or similar
    alert('PDF export coming soon! For now, use browser print (Cmd+P) to save as PDF.');
  };
  ...
  return (
    ...
    >
      ...
      <div className="mb-8 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          ...
          <button
            ...
            className="rounded-full border border-white bg-transparent px-6 py-2 text-sm font-light tracking-wide text-white transition-all duration-300 hover:bg-white hover:text-black"
          >
            Save as PDF
          </button>
        </div>
      ...
      {/* Main Report Card */}
      <div className="space-y-8 border border-gray-800 bg-white/[0.03] p-12 shadow-2xl">
        {/* Campaign Title */}
        <motion.div
      ...
      {/* Footer note */}
      <p className="mt-6 text-center text-xs font-light text-gray-700">
